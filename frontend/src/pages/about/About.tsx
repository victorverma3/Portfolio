    ...
    return (
        <div className="about-content">
            ...
            <p className="about-bio">
                ...
                parents, my younger sister, and our dog. I played football for
                10 years and started at left-guard at the varsity level for my
                high school team. I'm extremely proud of receiving multiple
                individual awards in middle school and high school, including
                being named a Central Mass All Star in 7th grade, but I will
                forever cherish the close friends and memories I made and the
                life lessons that I learned while playing the sport.
            </p>
            <p className="about-bio">
                ...
                especially the African savanna and the Amazon rainforest. I like
            ...
            <p className="about-bio">
                ...
                relations, geopolitical science, and history. I tell everyone
                that I wish I could experience college as an infinite loop and
